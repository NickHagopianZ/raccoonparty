...
static var nod_along = CardResource.new(
	...
	[BattleScores.Action.new("+1 Vibes"), BattleScores.Action.new("D1 Fear"), BattleScores.Action.new("D1 Sus")]
)
...
static var podcasts = CardResource.new(
	...
	[BattleScores.Action.new("-1 Vibes"), BattleScores.Action.new("+1 Fear")]
)
...
static var gonna_eat_that = CardResource.new(
	...
	[BattleScores.Action.new("-1 Vibes"), BattleScores.Action.new("+2 Fear"), BattleScores.Action.new("-1 Sus")]
)
static var garbage_man = CardResource.new(
	"Garbage Man",
	"Of course I don't eat trash, that would be pretty weird...\n\n+1 Fear\n+1 Sus",
	[BattleScores.Action.new("+1 Fear"), BattleScores.Action.new("+1 Sus")]
)
...
static var good_old_days = CardResource.new(
	...
	[BattleScores.Action.new("-1 Vibes"), BattleScores.Action.new("-1 Fear"), BattleScores.Action.new("-1 Sus")]
)
